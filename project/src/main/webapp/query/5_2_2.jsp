...
<head>
	<meta charset="UTF-8">
	<title>CPQG Grade Distribution Report</title>
</head>
<style>
	table,
	th,
...
<body>
	...
	<form action="5_2_2.jsp" method="POST">
    ...
    if (action != null && action.equals("submit")) {
        ...
        PreparedStatement statement1 = connection.prepareStatement("SELECT count_a FROM CPQG " +
                "WHERE title = ? AND instructor_name = ? AND quarter = ? ");
        PreparedStatement statement2 = connection.prepareStatement("SELECT count_b FROM CPQG " +
                "WHERE title = ? AND instructor_name = ? AND quarter = ? ");
         PreparedStatement statement3 = connection.prepareStatement("SELECT count_c FROM CPQG " +
                "WHERE title = ? AND instructor_name = ? AND quarter = ? ");        
         PreparedStatement statement4 = connection.prepareStatement("SELECT count_d FROM CPQG " +
                "WHERE title = ? AND instructor_name = ? AND quarter = ? ");
        PreparedStatement statement5 = connection.prepareStatement("SELECT count_other FROM CPQG " +
                "WHERE title = ? AND instructor_name = ? AND quarter = ? ");  
